/**
 * auth.js — Authentication handler for SAP SuccessFactors
 * Supports: SSO (SAP IAS / Azure AD / Okta), MFA (SAP Authenticator / Okta MFA)
 *
...
const BASE_URL = process.env.SUCCESSFACTORS_URL || 'https://performancemanager.successfactors.com/login';
const USERNAME = process.env.SUCCESSFACTORS_USERNAME;
const PASSWORD = process.env.SUCCESSFACTORS_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set SUCCESSFACTORS_USERNAME and SUCCESSFACTORS_PASSWORD in .env`);
  }

  console.log('Logging in to SAP SuccessFactors...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
